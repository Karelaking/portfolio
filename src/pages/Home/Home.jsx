...
const Home = () => {
  return (
    ...
    >
      <h2 className={`text-black text-xl`} data-aos="fade-down">
        My Portfolio
      </h2>
      <h1
        className={`uppercase px-4 overflow-hidden text-4xl sm:text-7xl text-center mt-3`}
        data-aos="fade-up"
        data-aos-delay="200"
      >
      ...
      <p
        className={`w-4/5 text-black text-center text-base sm:text-2xl mt-3`}
        data-aos="fade-in"
        data-aos-delay="400"
      >
